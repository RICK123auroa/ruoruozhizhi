export class CommonConstant {
    ...
    static readonly LOCAL_PATH: Resource = { "id": 0, "type": 30000, params: ['local/index.html'], "bundleName": "com.example.webcomponent", "moduleName": "entry" };
    static readonly VUE_PATH: string = 'resource://rawfile/vue3/index.html';
    /**
     * The host address of the server.
     */
    static readonly VUE_CLOUD_PATH: string = 'http://192.168.43.127:5173/index.html';
    static readonly CLOUD_PATH: string = 'http://192.168.43.127:9588/index.html';
    /**
     * Dialog text value.
     */
    static readonly WEB_ALERT_DIALOG_TEXT_VALUE: ResourceStr = { "id": 16777224, "type": 10003, params: [], "bundleName": "com.example.webcomponent", "moduleName": "entry" };
    /**
     * Size.
     */
